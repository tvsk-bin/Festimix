...
var yamahaMixerProfile = require("../mixers/yamaha01v/profile");
var babyfaceMixerProfile = require("../mixers/rmeBabyfaceProFs12/profile");
...
var yamaha01vDefault = addControls({
    ...
    capabilities: cloneCapabilities(yamahaMixerProfile.capabilities),
    maps: {
...
var rmeBabyfaceProFs12 = addControls({
    ...
    capabilities: cloneCapabilities(babyfaceMixerProfile.capabilities),
    maps: {
        channelFader: {},
        channelOn: {},
        pan: {},
