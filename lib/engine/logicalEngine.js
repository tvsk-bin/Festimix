    ...
    if (this.profile === "rmeBabyfaceProFs12") {
        if (control === "hpf") {
            if (value === "75" || value === "100") {
                ...
                commands.push(this.writeEq(channel, "HPF", "FREQ", value === "75" ? 38 : 49));
            } else {
...
LogicalEngine.prototype.setRawYamahaEqIntent = function(target, state) {
    ...
    (isBabyface ? ["HPF", "LOW", "MID", "HIGH"] : ["LOW", "LO_MID", "HI_MID", "HIGH"]).forEach(function(band) {
        ...
        if (values.q !== undefined) {
            if (isBabyface && (band === "LOW" || band === "HIGH") && parseInt(values.q, 10) >= 41) {
                commands.push(this.writeEq(targetKey, band, "Q_OR_TYPE", 42));
            } else {
                if (isBabyface && band === "LOW") commands.push(this.writeEq(targetKey, band, "Q_OR_TYPE", 0));
    ...
    if (this.profile === "rmeBabyfaceProFs12") {
        if (control === "hpf") {
            if (value === 75 || value === 100 || value === 175 || value === 250 || value === "75" || value === "100" || value === "175" || value === "250") {
                ...
                var auxHpfFreq = { 75: 38, 100: 49, 175: 61, 250: 70 }[value] || constants.hpfFreq[value];
